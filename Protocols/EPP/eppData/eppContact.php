...
class eppContact {
    ...
    /**
     *
     * @param eppContactPostalInfo $postalInfos
     * @param string $email
     * @param string $voice
     * @param string $fax
     ...
     * @return void
     */
    public function __construct($postalInfos = null, $email = null, $voice = null, $fax = null, $password = null, $status = null) {
    ...
    /**
     * Set a postalInfo object by number
     *
     * @param int $line
     * @param SidnContactPostalInfo $postalInfo
     */
    public function setPostalInfo($line, eppContactPostalInfo $postalInfo) {
        $this->postalInfo[$line] = $postalInfo;
    }
